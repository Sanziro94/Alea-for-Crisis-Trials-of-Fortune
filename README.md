# Alea for Crisis : Trial-of-Fortune
### Pre-Release
...
## Installation
So you know how to use a mouse ?? , good now if you are on windows easy , download from release and click .
But if you are on linux go with the terminal  the downloaded directory with
*cd Yourdirectory/*
and do : 
